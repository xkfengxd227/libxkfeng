...
#define 	FileCentroid 			"centroid.txt"
#define		FileMember 				"member.txt"
#define 	FileInnerLB 			"innerlb.txt"
#define 	FileNeighborCluster		"neighborcluster.txt"
#define 	FileAssign 				"assign.txt"
...
public:
	...
	int 				n;				/// number of all member points
	...
	Clustering(int _nc, int _d, int _n);
	~Clustering();
